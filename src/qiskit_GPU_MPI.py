...
# for blocking_qubits in range(1,29):
shots = 1024
depth = 10
qubits = 24
...
simulator = Aer.get_backend('aer_simulator_statevector', device = "GPU",blocking_enable=True , blocking_qubits = 20)
...
# 模拟器运行
result = execute(circ,simulator,cuStateVec_enable=True).result()
